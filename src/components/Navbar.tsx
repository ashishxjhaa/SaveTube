...
export default function Navbar() {
    ...
    return (
        <div className="fixed max-w-3xl w-[90%] md:w-full h-fit mx-auto top-4 z-50 flex items-center justify-between place-self-center flex-wrap gap-2 px-4 py-2 sm:py-3 mt-4 rounded-xl bg-teal-50/10 shadow-lg shadow-neutral-600/5 backdrop-blur-md">
